        ...
        <div className="container relative z-10 mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-white/40 max-w-2xl mx-auto text-lg">
              Preencha os dados do seu cartão abaixo para verificarmos se ele
              foi comprometido em algum vazamento de dados.
            </p>
          </motion.div>
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-white/40">
                <li className="flex items-start">
                  ...
                  <span>
                    Nunca compartilhe os dados do seu cartão em sites ou
                ...
                <li className="flex items-start">
                  <span className="mr-2 mt-0.5 text-primary">•</span>
                  <span>
                    Use sempre serviços de pagamento com autenticação de dois
                    fatores
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-lg p-6">
              ...
              <ul className="space-y-3 text-white/40">
                <li className="flex items-start">
                  <span className="mr-2 mt-0.5 text-primary">•</span>
                  <span>
                    Verifique regularmente seu extrato para identificar
                ...
                <li className="flex items-start">
                  <span className="mr-2 mt-0.5 text-primary">•</span>
                  <span>
                    Não clique em links suspeitos recebidos por email ou SMS
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2 mt-0.5 text-primary">•</span>

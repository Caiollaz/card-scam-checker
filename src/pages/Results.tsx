        ...
        <div className="container relative z-10 mx-auto max-w-4xl">
          ...
          >
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-lg p-6">
              <h4 className="font-semibold text-lg mb-3 text-white">Como se proteger de golpes reais:</h4>
              <ul className="space-y-3 text-left">
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-white/60">Sempre verifique se o site possui HTTPS (cadeado) e se o domínio é oficial</span>
                </li>
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-white/60">Desconfie de ofertas muito vantajosas ou urgentes</span>
                </li>
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-white/60">Nunca compartilhe o código de segurança (CVV) por telefone ou email</span>
                </li>
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-white/60">Ative as notificações por SMS ou app do seu banco para cada transação</span>
                </li>
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <span className="text-white/60">Em caso de dúvida, entre em contato diretamente com seu banco pelos canais oficiais</span>
                </li>
              </ul>
            </div>
          </motion.div>
